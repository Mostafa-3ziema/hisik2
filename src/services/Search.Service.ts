...
export class SearchService {
    ...
    SearchProduct(text:string){
        let endpoint="http://localhost:8000/api/product/?name__icontains="+text;
        const headers = new HttpHeaders({'Contant-Type':'application/json'});
        return this.http.get(endpoint,{headers:headers});
    }

    SearchBrand(text:string){
        let endpoint="http://localhost:8000/api/brand/?search="+text;
        const headers = new HttpHeaders({'Contant-Type':'application/json'});
        return this.http.get(endpoint,{headers:headers});
    }

    SearchCategory(text:string){
        let endpoint="http://localhost:8000/api/category/?search="+text;
        const headers = new HttpHeaders({'Contant-Type':'application/json'});
        return this.http.get(endpoint,{headers:headers});
    }

    Categoryproduct(text:string){
        let endpoint="http://localhost:8000/api/product/?Category__Name__icontains="+text;
        const headers = new HttpHeaders({'Contant-Type':'application/json'});
        return this.http.get(endpoint,{headers:headers});
    }

    BrandProduct(text:string){
        let endpoint="http://localhost:8000/api/product/?brand__Name__icontains="+text;
        const headers = new HttpHeaders({'Contant-Type':'application/json'});
        return this.http.get(endpoint,{headers:headers});
    }
